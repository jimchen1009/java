...
import com.ximuyi.demo.dubbo.api.DubboApiClient;
import com.ximuyi.demo.dubbo.api.DubboConfigs;
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		for (int i = 0; i < count; i++) {
			...
			for (ReferenceConfig<ICallbackService> reference : referenceList) {
				...
				//Serialized class com.ximuyi.demo.dubbo.api.callback.DubboCallbackClient$CallbackListener must implement java.io.Serializable
