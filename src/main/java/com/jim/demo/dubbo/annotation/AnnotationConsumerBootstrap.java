...
import com.jim.demo.dubbo.annotation.action.AnnotationAction;
...
public class AnnotationConsumerBootstrap {
	...
	@Configuration
	@EnableDubbo(scanBasePackages = "com.jim.demo.dubbo.annotation.action")
	@PropertySource("classpath:/dubbo/annotation/dubbo-consumer.properties")
	@ComponentScan(value = {"com.jim.demo.dubbo.annotation.action"})
