package com.jim.demo.swaphot.assist;
...
//        System.out.println("---" + context.getApplicationName());
        ...
        CtClass clazz = pool.get("com.jim.demo.swaphot.assist.Standard");
         ...
         * Exception in thread "main" java.net.ConnectException: Connection refused: connect
         ...
         at com.jim.demo.swaphot.assist.SpiderStandaloneMainAnb.main(SpiderStandaloneMainAnb.java:21)
         */
        HotSwapper swap = new HotSwapper(8000);
        swap.reload("com.jim.demo.swaphot.assist.Standard", clazz.toBytecode());
        standard.doSomething();
    }
}
