package com.jim.demo.mybatis;

import com.alibaba.fastjson.JSON;
import com.mchange.v2.c3p0.ComboPooledDataSource;
import com.jim.demo.mybatis.config.StringTypeHandler;
import com.jim.demo.mybatis.mapper.OptimizeMapper;
import com.jim.demo.mybatis.mapper.SupplierMapper;
import com.jim.demo.mybatis.model.Optimize;
...
//            mapper1.deleteByExample(new SupplierExample());
    ...
    private static SqlSessionFactory bulidCode(String dbDataSource) throws IOException, PropertyVetoException {
        ...
        FindFile file = new FindFile().searchPath("D:\\demo\\java\\src\\main\\java\\com\\jim\\demo\\mybatis\\db");
